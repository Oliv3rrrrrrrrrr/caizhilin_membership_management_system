          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">会员详情</h1>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 lg:space-x-3">
              ...
              >
                ...
                <span className="hidden sm:inline">编辑会员</span>
      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-white/80 text-sm sm:text-base lg:text-lg">会员ID: {membership.id}</p>
                  </div>
                </div>
                <div className="text-left sm:text-right">
                  <div className="text-white font-bold text-lg sm:text-xl mb-1">{membership.cardNumber}</div>
                  <div className="text-white/80 text-sm sm:text-base">{membership.cardType}</div>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
                ...
                <div className="flex items-center space-x-4 sm:space-x-6">
                  <div className="text-center">
                    ...
                    <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">剩余次数</div>
                  </div>
                  <div className="text-center">
                    <div className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white">
                      {membershipDuration}
                    </div>
                    <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">会员天数</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center mb-4 sm:mb-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">基本信息</h3>
            </div>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                ...
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">姓名</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{membership.name}</div>
                </div>
              </div>
              ...
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{membership.phone}</div>
                </div>
              </div>
              ...
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                ...
                <div className="flex-1">
                  ...
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{membership.cardNumber}</div>
                </div>
              </div>

              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiCreditCard className="text-indigo-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">卡类型</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{membership.cardType}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center mb-4 sm:mb-6">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center mr-3 sm:mr-4">
                <FiTrendingUp className="text-white text-sm sm:text-base" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">业务信息</h3>
            </div>

            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiPackage className={`mr-3 sm:mr-4 text-base sm:text-lg ${isActive ? 'text-green-500' : 'text-red-500'
                  }`} />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">剩余汤品</div>
                  <div className={`font-semibold text-sm sm:text-base lg:text-lg ${isActive
              ...
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiCalendar className="text-blue-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">发卡日期</div>
              ...
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiClock className="text-orange-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">会员时长</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">
              ...
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiTrendingDown className="text-purple-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">使用情况</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">
                    {isActive ? '正常使用中' : '已用完'}
                  </div>
                </div>
        ...
        <div className="mt-6 sm:mt-8 bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 border border-gray-100 dark:border-gray-700">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            ...
            >
              <div className="flex items-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mr-3 sm:mr-4">
                  <FiEdit2 className="text-white text-sm sm:text-base lg:text-xl" />
                </div>
                <div className="text-left">
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">编辑会员</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">修改会员信息</div>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-green-500 to-green-600 rounded-xl flex items-center justify-center mr-3 sm:mr-4">
            ...
            <button
              onClick={() => router.push('/memberships')}
              className="p-4 sm:p-6 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600 rounded-xl border border-gray-200 dark:border-gray-600 hover:from-gray-100 hover:to-gray-200 dark:hover:from-gray-600 dark:hover:to-gray-500 transition-all duration-200 transform hover:scale-105 cursor-pointer sm:col-span-2 lg:col-span-1"
            >
              <div className="flex items-center">
                <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-gradient-to-br from-gray-500 to-gray-600 rounded-xl flex items-center justify-center mr-3 sm:mr-4">
                  <FiArrowLeft className="text-white text-sm sm:text-base lg:text-xl" />
                </div>
                <div className="text-left">
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">返回会员列表</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">查看所有会员</div>
                </div>
              </div>
            </button>
          </div>

      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        <div className="flex items-center justify-center h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base lg:text-lg">正在加载喝汤记录...</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">喝汤记录详情</h1>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2 lg:space-x-3">
              ...
              <button
                ...
                className="px-3 sm:px-4 py-2 bg-gradient-to-r from-indigo-500 to-indigo-600 hover:from-indigo-600 hover:to-indigo-700 text-white rounded-xl flex items-center justify-center font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 cursor-pointer text-xs sm:text-sm"
              >
                <FiEdit2 className="mr-1 sm:mr-2 text-xs sm:text-sm" />
                <span className="hidden sm:inline">编辑记录</span>
                <span className="sm:hidden">编辑</span>
              </button>
              <button
                onClick={handleDelete}
                className="px-3 sm:px-4 py-2 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-white rounded-xl flex items-center justify-center font-medium transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-105 cursor-pointer text-xs sm:text-sm"
              >
                <FiTrash2 className="mr-1 sm:mr-2 text-xs sm:text-sm" />
      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg overflow-hidden border border-gray-100 dark:border-gray-700">
            <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 bg-gradient-to-r from-orange-500 to-orange-600">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-3 sm:space-y-0">
                <div className="flex items-center">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 bg-white/20 rounded-full flex items-center justify-center mr-3 sm:mr-4 lg:mr-6">
                    <FiPackage className="text-white text-lg sm:text-xl lg:text-2xl" />
                  </div>
                  <div>
                    <h2 className="text-lg sm:text-xl lg:text-2xl font-bold text-white mb-1">{record.soup.name}</h2>
                  </div>
                </div>
                <div className="text-left sm:text-right">
                  <div className="text-white font-bold text-base sm:text-lg lg:text-xl mb-1">{record.soup.type}</div>
                  <div className="text-white/80 text-xs sm:text-sm">汤品类型</div>
                </div>
              </div>
            </div>
            ...
            <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-600">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div className="w-3 h-3 sm:w-4 sm:h-4 rounded-full mr-2 sm:mr-3 bg-green-500"></div>
                  <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center mb-4 sm:mb-6">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl flex items-center justify-center mr-3 sm:mr-4">
                <FiCoffee className="text-white text-sm sm:text-base" />
              </div>
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">喝汤信息</h3>
            </div>

            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiPackage className="text-orange-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">汤品名称</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{record.soup.name}</div>
                </div>
              </div>

              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiTrendingUp className="text-blue-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">汤品类型</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{record.soup.type}</div>
                </div>
              </div>

              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiCalendar className="text-green-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">喝汤日期</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{formattedDate}</div>
                </div>
              </div>

              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiClock className="text-purple-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">喝汤时间</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{formattedTime}</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 border border-gray-100 dark:border-gray-700">
            <div className="flex items-center mb-4 sm:mb-6">
              ...
              <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">会员信息</h3>
            </div>

            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiUser className="text-blue-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">会员姓名</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{record.membership.name}</div>
                </div>
              </div>

              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiPhone className="text-green-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">手机号</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{record.membership.phone}</div>
                </div>
              </div>

              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiCreditCard className="text-purple-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">卡号</div>
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base lg:text-lg">{record.membership.cardNumber}</div>
                </div>
              </div>
              ...
              <div className="flex items-center p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors">
                <FiPackage className="text-orange-500 mr-3 sm:mr-4 text-base sm:text-lg" />
                <div className="flex-1">
                  <div className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">剩余次数</div>
                  <div className={`font-semibold text-sm sm:text-base lg:text-lg ${record.membership.remainingSoups > 0
        ...
        {/* 快速操作 */}
        <div className="mt-6 sm:mt-8 bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 lg:p-8 border border-gray-100 dark:border-gray-700">
          <h3 className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6">快速操作</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            ...
            >
              <div className="flex items-center">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-xl flex items-center justify-center mr-3 sm:mr-4">
                  <FiEdit2 className="text-white text-base sm:text-xl" />
                </div>
                <div className="text-left">
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">编辑记录</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">修改喝汤信息</div>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                ...
                <div className="text-left">
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">会员喝汤记录</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">查看该会员所有喝汤记录</div>
                </div>
              </div>
            </button>
            ...
            >
              <div className="flex items-center">
                <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl flex items-center justify-center mr-3 sm:mr-4">
                  <FiUser className="text-white text-base sm:text-xl" />
                </div>
                <div className="text-left">
                  <div className="font-semibold text-gray-900 dark:text-white text-sm sm:text-base">会员详情</div>
                  <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">查看会员信息</div>
                </div>
              </div>
            </button>
          </div>
